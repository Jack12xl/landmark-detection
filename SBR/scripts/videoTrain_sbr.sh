...
CUDA_VISIBLE_DEVICES=3 python ./exps/lk_main.py \
	--train_lists ./cache_data/lists/CCTV/cctv-sbr.lst \
	              ./cache_data/lists/300W/300w.train.DET \
	--eval_ilists ./cache_data/lists/CCTV/cctv-sbr.lst \
	--num_pts 68 \
	--model_config ./configs/Detector.config \
	--opt_config   ./configs/LK.SGD.config \
	--lk_config    ./configs/mix.lk.config \
	--video_parser x-1-1 --save_path ./snapshots/CPM-SBR-cctv \
